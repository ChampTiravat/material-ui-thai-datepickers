...
exports.DatePickerToolbar = function (_a) {
    ...
    return (React.createElement(PickerToolbar_1.default, { isLandscape: isLandscape, className: clsx_1.default((_b = {},
            ...
            _b)) },
        React.createElement(ToolbarButton_1.default, { variant: isYearOnly ? 'h3' : 'subtitle1', onClick: function () { return setOpenView('year'); }, selected: openView === 'year', 
            // label={utils.getYearText(date)} //TODO: read from prop
            label: "" + (utils.getYear(date) + 543) }),
        !isYearOnly && !isYearAndMonth && (React.createElement(ToolbarButton_1.default, { variant: "h4", selected: openView === 'date', onClick: function () { return setOpenView('date'); }, align: isLandscape ? 'left' : 'center', 
            // label={utils.getDatePickerHeaderText(date)} //TODO: read from prop
            label: utils.format(date, 'ddd D MMM'), className: clsx_1.default((_c = {}, _c[classes.dateLandscape] = isLandscape, _c)) })),
