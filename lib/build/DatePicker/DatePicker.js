...
function (_PureComponent) {
  ...
  _proto.render = function render() {
    var _this$props = this.props,
        ...
        pickerHeaderFormat = _this$props.pickerHeaderFormat,
        yearOffset = _this$props.yearOffset;
    var showYearSelection = this.state.showYearSelection;
    var modYear = utils.getYear(this.date) + parseInt(yearOffset, 10);
    return _react.default.createElement(_react.Fragment, null, _react.default.createElement(_PickerToolbar.default, null, _react.default.createElement(_ToolbarButton.default, {
      ...
      selected: !showYearSelection,
      label: pickerHeaderFormat ? utils.format(this.date, pickerHeaderFormat) : utils.getDatePickerHeaderText(this.date)
...
DatePicker.propTypes = {
  ...
  pickerHeaderFormat: _propTypes.default.string,
  yearOffset: _propTypes.default.number
};
