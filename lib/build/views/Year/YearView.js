...
exports.YearSelection = function (_a) {
    ...
    return (React.createElement("div", { className: classes.container }, utils.getYearRange(minDate, maxDate).map(function (year) {
        ...
        , { 
            // key={utils.getYearText(year)} //TODO: read from prop
            key: "" + (utils.getYear(date) + 543), selected: selected, value: yearNumber, onSelect: onYearSelect, ref: selected ? selectedYearRef : undefined, disabled: Boolean((disablePast && utils.isBeforeYear(year, utils.date())) ||
                (disableFuture && utils.isAfterYear(year, utils.date()))) },
            " //TODO: read from prop", "" + (utils.getYear(date) + 543)));
    })));
};
