...
export var DatePickerToolbar = function DatePickerToolbar(_ref) {
  ...
  return React.createElement(PickerToolbar, {
    ...
    selected: openView === 'year' // label={utils.getYearText(date)} //TODO: read from prop
    ,
    label: "".concat(utils.getYear(date) + 543)
    ...
    align: isLandscape ? 'left' : 'center' // label={utils.getDatePickerHeaderText(date)} //TODO: read from prop
    ,
