...
export var YearSelection = function YearSelection(_ref) {
  ...
  return React.createElement("div", {
    ...
    return React.createElement(Year // key={utils.getYearText(year)} //TODO: read from prop
    , {
      key: "".concat(utils.getYear(date) + 543),
      selected: selected,
      value: yearNumber,
    ...
    }, " //TODO: read from prop", "".concat(utils.getYear(date) + 543));
  }));
};