...
var DateTimePickerHeader = function DateTimePickerHeader(props) {
  var date = props.date,
      ...
      utils = props.utils,
      ampm = props.ampm
      pickerHeaderFormat = props.pickerHeaderFormat,
  ...
  var modYear = utils.getYear(date) + parseInt(yearOffset, 10);
  return _react.default.createElement(_PickerToolbar.default, {
    ...
    label: pickerHeaderFormat ? utils.format(date, pickerHeaderFormat) : utils.getDateTimePickerHeaderText(date)
  })), _react.default.createElement("div", {
